...
export type NavTab = 'dashboard' | 'holdings' | 'allocation' | 'dividends' | 'news';
...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const tabs: { id: NavTab; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'dividends', label: 'Dividends', icon: <Coins className="w-5 h-5" /> },
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              <button 
                ...
                className="flex items-center space-x-2.5 group text-left cursor-pointer focus:outline-none min-h-[44px] py-1"
              >
                <div className="w-7 h-7 bg-[#2563EB] rounded-sm flex items-center justify-center text-white shadow-xs">
                ...
                <div className="flex items-center gap-2.5">
                  <span className="text-xl font-bold tracking-tight uppercase text-[#111827]">
                    Johnfolio
                  </span>
                  
                  {/* Subtle Firestore Sync Dot: green = synced, amber = saving, red = error */}
                  <div className="flex items-center gap-1.5 text-[11px] font-medium pl-2.5 border-l border-[#E5E7EB]">
                    <span 
            ...
            <div className="flex items-center space-x-2 sm:space-x-2.5">
              ...
              <button
                ...
                className="inline-flex items-center space-x-1.5 px-2.5 sm:px-3 py-1.5 text-xs font-medium text-[#4B5563] hover:text-[#111827] bg-white hover:bg-gray-50 border border-[#E5E7EB] rounded-sm transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-flex items-center space-x-1.5 px-2.5 sm:px-3 py-1.5 text-xs font-medium text-[#111827] bg-white border border-[#E5E7EB] rounded-sm hover:bg-gray-50 active:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-flex items-center space-x-1.5 px-3 sm:px-3.5 py-1.5 text-xs font-semibold text-white bg-[#2563EB] hover:bg-blue-700 active:bg-blue-800 rounded-sm transition-all shadow-xs cursor-pointer"
              >
